    ...
    return Roact.createElement("ScreenGui", {
        ...
        Container = Roact.createElement("Frame",{
            ...
            Tutorial = Roact.createElement("TextLabel",{
                ...
                --Transparency = 1,
                BorderSizePixel = 0,
                Text = "Click/press on the log to chop!"
            }),
...
function Interface:didMount()
    ...
    Modules["Generate"].SingleSpawn("Log", script.Name)
...
function Game.Start()
    if game_start == false then
        ...
        game_handle = Roact.mount(Roact.createElement(Interface), PlayerGui, "Chop Interface")
        game_start = true
    end
end
