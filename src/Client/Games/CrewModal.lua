...
local Crew_Modal = Roact.Component:extend("CrewModal")
        ...
        Container = Roact.createElement("ImageLabel",{
            ...
            Parchment = Roact.createElement("Frame", {
                ...
                Message = Roact.createElement("TextLabel", {
                    ...
                    Text = "You are a Knight! Complete your tasks to win.",
...
function Crew_Modal:didMount()
    ...
    --local tweeninfo = TweenInfo.new(5, Enum.EasingStyle.Quad, Enum.EasingDirection.In, 0, false,  0) 
    --local fade_tween = TweenService:Create( self.messageref:getValue(), tweeninfo, {Transparency = 0})
...
function CrewModal.Activate()
  
    game_handle = Roact.mount(Roact.createElement(Crew_Modal), PlayerGui, "Crew Modal")

    
end

function CrewModal.Deactivate()
